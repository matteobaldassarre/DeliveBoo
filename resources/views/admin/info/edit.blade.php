            ...
            <form action="{{ route('admin-info.update', ['slug' => $user_info->slug]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <div class="row col-md-6 col-lg-7 margin_auto">
                        ...
                        <input type="text" class="form-control" id="restaurant_name" name="restaurant_name" placeholder="Inserisci il nuovo nome del ristorante" value="{{ $user_info->restaurant_name }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-md-6 col-lg-7 margin_auto">
                        ...
                        <input type="text" class="form-control" id="address" name="address" placeholder="Inserisci il nuovo indirizzo del ristorante" value="{{ $user_info->address }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    <div class="row col-md-6 col-lg-7 margin_auto">
                        ...
                        <input type="text" class="form-control" id="VAT" name="VAT" placeholder="Inserisci il nuovo Nº di Partita IVA" value="{{ $user_info->VAT }}">
                    </div>
                </div> 
